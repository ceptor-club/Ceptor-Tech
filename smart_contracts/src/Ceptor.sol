...
contract Ceptors is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, ERC721Burnable {
    ...
    function mint(string memory uri) public whenNotPaused {
        require(isBefore(userTimers[msg.sender]), "Time is up! Insert another Dize to get more time.");
