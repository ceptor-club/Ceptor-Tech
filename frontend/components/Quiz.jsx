...
export default function Quiz() {
  ...
  const questionComponentMap = {
    ...
    [State.QUESTION5]: (
      <PartyPos partyPos={partyPos} setPartyPos={setPartyPos} />
    ),
    [State.QUESTION6]: (
      <AlignmentGoodEvil
        myAlignment={myAlignment}
    ...
    [State.QUESTION7]: (
      <HumanoidOrNo
        humanoidOrNo={humanoidOrNo}
        setHumanoidOrNo={setHumanoidOrNo}
  ...
  return (
    <div className="text-ceptor mx-32 p-8 max-w-500">
      <h1 className="text-center text-6xl leading-8 mb-4">
        Ceptor Club Character
      </h1>
      ...
      <div className="fixed bottom-0 right-64">
        {currentState !== State.QUESTION1 &&
        currentState !== State.CHARACTER_PAGE ? (
          <button
