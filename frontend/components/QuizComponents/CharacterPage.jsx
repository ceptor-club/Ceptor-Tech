...
export default function CharacterPage() {
  ...
  //Stats
  character.strength = setAbilityScore(
    character.interest,
    character.species,
    "strength"
  );
  character.dexterity = setAbilityScore(
    character.interest,
    character.species,
    "dexterity"
  );
  character.constitution = setAbilityScore(
    character.interest,
    character.species,
    "constitution"
  );
  character.intelligence = setAbilityScore(
    character.interest,
    character.species,
    "intelligence"
  );
  character.wisdom = setAbilityScore(
    character.interest,
    character.species,
    "sWiwisdoms"
  );
  character.charisma = setAbilityScore(
    character.interest,
    character.species,
    "charisma"
  );
  ...
  character.hitPoints = calculateHitPoint(
  ...
  // //Saving Throws
  character.savingThrowStrength = calculateSavingThrows(
    character.myClass,
    "strengthMod",
    character.proficiencyBonus,
    character.strengthMod
  );
  character.savingThrowDexterity = calculateSavingThrows(
    character.myClass,
    "dexterityMod",
    character.proficiencyBonus,
    character.dexterityMod
  );
  character.savingThrowConstitution = calculateSavingThrows(
    character.myClass,
    "constitutionMod",
    character.proficiencyBonus,
    character.constitutionMod
  );
  character.savingThrowIntelligence = calculateSavingThrows(
    character.myClass,
    "intelligenceMod",
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.savingThrowWisdom = calculateSavingThrows(
    character.myClass,
    "wisdomMod",
    character.proficiencyBonus,
    character.wisdomMod
  );
  character.savingThrowCharisma = calculateSavingThrows(
    character.myClass,
    "charismaMod",
    character.proficiencyBonus,
  ...
  // //Skills
  character.acrobatics = calculateSkill(
    "dexterity",
    character.myClass,
    character.proficiencyBonus,
    character.dexterityMod
  );
  character.animalHandling = calculateSkill(
    "wisdom",
    character.myClass,
    character.proficiencyBonus,
    character.wisdomMod
  );
  character.arcana = calculateSkill(
    "intelligence",
    character.myClass,
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.athletics = calculateSkill(
    "strenth",
    character.myClass,
    character.proficiencyBonus,
    character.strengthMod
  );
  character.deception = calculateSkill(
    "charisma",
    character.myClass,
    character.proficiencyBonus,
    character.charismaMod
  );
  character.history = calculateSkill(
    "intelligence",
    character.myClass,
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.insight = calculateSkill(
    "wisdom",
    character.myClass,
    character.proficiencyBonus,
    character.wisdomMod
  );
  character.intimidation = calculateSkill(
    "charisma",
    character.myClass,
    character.proficiencyBonus,
    character.charismaMod
  );
  character.investigate = calculateSkill(
    "intelligence",
    character.myClass,
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.medicine = calculateSkill(
    "wisdom",
    character.myClass,
    character.proficiencyBonus,
    character.wisdomMod
  );
  character.nature = calculateSkill(
    "intelligence",
    character.myClass,
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.perception = calculateSkill(
    "wisdom",
    character.myClass,
    character.proficiencyBonus,
    character.wisdomMod
  );
  character.performance = calculateSkill(
    "charisma",
    character.myClass,
    character.proficiencyBonus,
    character.charismaMod
  );
  character.persuasion = calculateSkill(
    "charisma",
    character.myClass,
    character.proficiencyBonus,
    character.charismaMod
  );
  character.religion = calculateSkill(
    "intelligence",
    character.myClass,
    character.proficiencyBonus,
    character.intelligenceMod
  );
  character.sleightOfHand = calculateSkill(
    "dexterity",
    character.myClass,
    character.proficiencyBonus,
    character.dexterityMod
  );
  character.stealth = calculateSkill(
    "dexterity",
    character.myClass,
    character.proficiencyBonus,
    character.dexterityMod
  );
  character.survival = calculateSkill(
    "wisdom",
    character.myClass,
    character.proficiencyBonus,
    character.wisdomMod
  ...
  const findHighestTraitAndScore = (obj) =>
  ...
  const findLowestTraitAndScore = (obj) =>
    Object.entries(obj).reduce(
      ([minKey, minValue], [key, value]) =>
        value < minValue ? [key, value] : [minKey, minValue],
      [null, Infinity]
    );
  ...
  if (character.gender === "They") {
    characterDescription = `${character.charName} is a level ${
      character.level
    } ${speciesAdj} ${character.myClass.toLowerCase()}.\n${
      character.gender
    } have a background as a ${character.background.toLowerCase()} and maintain a ${character.myAlignment.toLowerCase()} alignment.\n${
      character.charName
    } is known for ${genderPos} ${htModifier} ${highestTrait} but is not well-regarded for ${genderPos} ${lowestTrait}, which is ${ltModifier}.\n${
      character.gender
    } prefer to use the ${character.weapon.toLowerCase()} in battle and like to ${
      character.partyPos
    }`;
  } else {
    characterDescription = `${character.charName} is a level ${
      ...
      character.gender
    } has a background as a ${character.background.toLowerCase()} and maintains a ${character.myAlignment.toLowerCase()} alignment.\n${
      character.charName
    } is known for ${genderPos} ${htModifier} ${highestTrait} but is not well-regarded for ${genderPos} ${lowestTrait}, which is ${ltModifier}.\n${
      character.gender
    } prefers to use the ${character.weapon.toLowerCase()} in battle and likes to ${
      character.partyPos
    }`;
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-row mx-auto items-center justify-center">
        <div className="flex flex-col m-2 text-base">
          <div className="" id="alignment-div">
            <div id="Character-Alignment">
              My Alignment: {character.myAlignment}
            </div>
          </div>
          ...
          <div className="" id="background-div">
            <div id="Character-Background">
              My Background: {character.background}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Strength">
              Strength / Ability Modifier: {character.strength} /{" "}
              {character.strengthMod}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Dexterity">
              Dexterity / Ability Modifier: {character.dexterity} /{" "}
              {character.dexterityMod}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Constitution">
              Constitution / Ability Modifier: {character.constitution} /{" "}
              {character.constitutionMod}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Intelligence">
              Intelligence / Ability Modifier: {character.intelligence} /{" "}
              {character.intelligenceMod}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Wisdom">
              Wisdom / Ability Modifier: {character.wisdom} /{" "}
              {character.wisdomMod}
            </div>
          </div>
          <div className="" id="background-div">
            <div id="Character-Charisma">
              Charisma / Ability Modifier: {character.charisma} /{" "}
              {character.charismaMod}
            </div>
          </div>
        </div>
        <div className="ml-4">
          <Image
            src="/images/CREATE/placeholder.png"
            alt=""
            width={300}
            height={300}
            className=""
      ...
      <div className="flex justify-center flex-col items-center">
        <div
          ...
          style={{
            height: isMessageVisible ? "30px" : "30px",
            overflow: "hidden",
          }}
        >
          {isMessageVisible && (
