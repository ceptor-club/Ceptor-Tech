...
export default function NameLevelGender({
  charName,
  setCharName,
  level,
  setLevel,
  ...
  return (
    <div>
      <h3 className="leading-8 text-2xl">
      ...
      <div className="flex flex-wrap m-8 flex-col" id="pName-div">
        ...
        <input
          className="text-base p-8 m-4 placeholder-black text-black"
          type="text"
        ...
        <input
          type="button"
          className=" cursor-pointer bg-ceptor border-0 text-black p-4 text-center no-underline inline-block text-base m-4"
          id="random-name-button"
          onClick={(e) => setCharName(RandomName(e.target.value))}
          value="Random Name"
        />
      </div>
      <div className="flex flex-row">
        <div className="flex flex-wrap m-8 flex-col" id="pLevel-div">
          ...
          <input
            className="text-base text-black p-8 m-4"
            type="number"
            value={level}
            min={1}
            max={20}
