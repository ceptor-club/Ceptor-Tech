...
const UploadPage = () => {
  ...
  const handleRoleSelection = (role) => {
    const userValue = role === 'Gamemaster' ? 'gm' : 'player'; // Assign 'gm' if 'Gamemaster' button clicked, otherwise 'player'
    setUser(userValue);
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col justify-center items-center text-white">
      ...
      <div className="text-center mt-4 font-nothing-you-could-do">
        <label htmlFor="photo-upload" className="cursor-pointer text-white">Upload Photo</label>
        <input
          type="file"
          id="photo-upload"
          className="hidden"
