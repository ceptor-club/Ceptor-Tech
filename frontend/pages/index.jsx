    ...
    <div className="bg-black text-white text-center py-20 px-10 relative h-screen">
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        {isLoginPopupOpen && (
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg text-center relative">
              ...
              <p className="font-oswald text-black">Please connect your wallet and choose the network to mint your CCID (Ceptor Club ID)</p>
              <WalletConnectButton />
            </div>
          </div>
        )}
        ...
        {isLoginSuccessPopupOpen && (
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg text-center relative">
              <p className="font-oswald text-black">Your wallet is successfully connected</p>
            </div>
          </div>
        )}
